...
class SafetyGlovesImageAnnotationTask(TaskCreation):
    def __init__(
        self,
        credentials_arn: str,
        ...
        self.project = "safety_gloves_image_annotation"
        super().__init__(
            self.project,
    ...
    def create_task(
        ...
        for image in glob_from_bucket(bucket_name, dir_name, ("jpg", "png")):
            ...
            unique_id = f"{data_collection_uuid}_safetygloves_{frame_uuid}"
