...
class IntersectionMachine(BaseStateMachine):
    NAME = "intersection"
    INCIDENT_TYPE_NAME = "Speeding At Intersection"
    INCIDENT_TYPE_ID = "NO_STOP_AT_INTERSECTION"
    ...
    def get_relevant_actor(
        ...
        if (
            ...
            and state_event_message.event_type
