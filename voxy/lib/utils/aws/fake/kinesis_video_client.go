...
func (fake *KinesisVideoClient) GetDataEndpoint(arg1 context.Context, arg2 *kinesisvideo.GetDataEndpointInput, arg3 ...func(*kinesisvideo.Options)) (*kinesisvideo.GetDataEndpointOutput, error) {
...
func (fake *KinesisVideoClient) GetDataEndpointCallCount() int {
	fake.getDataEndpointMutex.RLock()
	defer fake.getDataEndpointMutex.RUnlock()
	return len(fake.getDataEndpointArgsForCall)
}

func (fake *KinesisVideoClient) GetDataEndpointCalls(stub func(context.Context, *kinesisvideo.GetDataEndpointInput, ...func(*kinesisvideo.Options)) (*kinesisvideo.GetDataEndpointOutput, error)) {
	fake.getDataEndpointMutex.Lock()
	defer fake.getDataEndpointMutex.Unlock()
	fake.GetDataEndpointStub = stub
}

func (fake *KinesisVideoClient) GetDataEndpointArgsForCall(i int) (context.Context, *kinesisvideo.GetDataEndpointInput, []func(*kinesisvideo.Options)) {
	fake.getDataEndpointMutex.RLock()
	defer fake.getDataEndpointMutex.RUnlock()
...
func (fake *KinesisVideoClient) GetDataEndpointReturns(result1 *kinesisvideo.GetDataEndpointOutput, result2 error) {
	fake.getDataEndpointMutex.Lock()
	defer fake.getDataEndpointMutex.Unlock()
...
func (fake *KinesisVideoClient) GetDataEndpointReturnsOnCall(i int, result1 *kinesisvideo.GetDataEndpointOutput, result2 error) {
	fake.getDataEndpointMutex.Lock()
	defer fake.getDataEndpointMutex.Unlock()
	fake.GetDataEndpointStub = nil
...
func (fake *KinesisVideoClient) Invocations() map[string][][]interface{} {
...
func (fake *KinesisVideoClient) recordInvocation(key string, args []interface{}) {
