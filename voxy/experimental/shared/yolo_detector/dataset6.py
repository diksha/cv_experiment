...
"""
names = ["PERSON", "PIT"]
ordered_classes_to_keep = [ActorCategory.PERSON, ActorCategory.PIT]
...
if __name__ == "__main__":
    ...
    dataset_output_path = "gs://voxel-users/common/yolo/dataset6"
    exp_output_path = "gs://voxel-users/common/yolo/dataset6"
    ...
    # TRAIN
    training_logset_name = "data/logsets/common/yolo_detector/train-2021-04-07"
    train_videos = videos_from_logsets(training_logset_name)
    videosets.append(train_videos)

    # VAL
    val_logset_name = "data/logsets/common/yolo_detector/val-2021-04-07"
    val_videos = videos_from_logsets(val_logset_name)
    videosets.append(val_videos)

    # TEST
    test_logset_name = "data/logsets/common/yolo_detector/test-2021-04-07"
    ...
    dump_to_gcs(
        os.path.join(exp_output_path, "dataset6.yaml"), dataset_yaml, "text/plain"
    )
