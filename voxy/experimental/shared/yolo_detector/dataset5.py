...
if __name__ == "__main__":
    ...
    dataset_output_path = "gs://voxel-users/common/yolo/dataset5"
    exp_output_path = "gs://voxel-users/common/yolo/dataset5"
    ...
    dump_to_gcs(
        os.path.join(exp_output_path, "dataset5.yaml"), dataset_yaml, "text/plain"
    )
