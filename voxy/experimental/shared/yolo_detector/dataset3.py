...
if __name__ == "__main__":
    ...
    dataset_output_path = "gs://voxel-users/common/yolo/dataset3"
    exp_output_path = "gs://voxel-users/common/yolo/dataset3"
    ...
    dump_to_gcs(
        os.path.join(exp_output_path, "dataset3.yaml"), dataset_yaml, "text/plain"
    )
