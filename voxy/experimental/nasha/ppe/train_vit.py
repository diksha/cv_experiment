...
class TrainViTImageClassifier:
    ...
    def __init__(self):
        ...
        self.data_paths = {
            "laredo": "/home/nasha/data/datasets/vest-dataset-clean/",
            "walton": "/home/nasha/data/datasets/verst/walton/v1.3/train/",
        }
        self.dataloaders = {}
        ...
        self.config = {
            ...
            "num_samples": {},
            "model_path": "/home/nasha/voxel/experimental/nasha/ppe/models/",
        }
        self.optimizer = None
        self.scheduler = None
        self.model = None
