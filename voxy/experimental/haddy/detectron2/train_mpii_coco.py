...
if __name__ == "__main__":
    ...
    MetadataCatalog.get("voxel_mpii_as_coco_train").keypoint_names = MPII_PERSON_KEYPOINT_NAMES
    MetadataCatalog.get("voxel_mpii_as_coco_train").keypoint_flip_map = MPII_PERSON_KEYPOINT_FLIP_MAP

    MetadataCatalog.get("voxel_mpii_as_coco_val").keypoint_names = MPII_PERSON_KEYPOINT_NAMES
    MetadataCatalog.get("voxel_mpii_as_coco_val").keypoint_flip_map = MPII_PERSON_KEYPOINT_FLIP_MAP
