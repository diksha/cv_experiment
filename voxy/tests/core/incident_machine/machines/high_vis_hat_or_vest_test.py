...
from core.incident_machine.machines.high_vis_hat_or_vest import (
    ActorMachine,
    HighVisHatOrVestViolationMachine,
)
...
class SafetyVestTest(unittest.TestCase):
    def test_transitions(self) -> None:
        ...
        self.assertEqual(machine.state, "not_wearing_hat_or_vest_on_floor")
        incident_list = []
    ...
    def test_state_and_events(self):
        ...
        machine = HighVisHatOrVestViolationMachine("", {})
        actor_id = 1
        track_uuid = "1"
        _state = State(
            timestamp_ms=0,
