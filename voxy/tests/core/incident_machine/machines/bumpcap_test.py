...
from core.incident_machine.machines.bumpcap import (
    ActorMachine,
    BumpCapViolationMachine,
)
...
class HardHatTest(unittest.TestCase):
    def test_transitions(self) -> None:
        ...
        machine.update_person_state(
            person_is_wearing_bumpcap=False,
            person_is_associated=False,
        )
        self.assertEqual(machine.state, "not_wearing_bumpcap_on_floor")
        incident_list = []
        ...
        machine.state_event_start_timestamp_ms = 6000
        machine.state_event_end_timestamp_ms = 12000
        machine.update_person_state(
            person_is_wearing_bumpcap=False,
            person_is_associated=False,
        )
    ...
    def test_state_and_events(self):
        ...
        machine = BumpCapViolationMachine("", {})
        actor_id = 1
        track_uuid = "1"
        _state = State(
            timestamp_ms=0,
            ...
            actor_id=actor_id,
            person_is_wearing_hard_hat=False,
            person_is_associated=True,
