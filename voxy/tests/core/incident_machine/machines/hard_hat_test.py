...
from core.incident_machine.machines.hardhat import (
    ActorMachine,
    HardHatViolationMachine,
)
...
class HardHatTest(unittest.TestCase):
    def test_transitions(self) -> None:
        ...
        self.assertEqual(machine.state, "not_wearing_hat_on_floor")
        incident_list = []
        ...
        machine.state_event_end_timestamp_ms = 120000
        machine.update_person_state(
            person_is_wearing_hard_hat=False,
            person_is_associated=False,
        )
    ...
    def test_state_and_events(self):
        ...
        machine = HardHatViolationMachine("", {})
        actor_id = 1
        track_uuid = "1"
        _state = State(
            timestamp_ms=0,
