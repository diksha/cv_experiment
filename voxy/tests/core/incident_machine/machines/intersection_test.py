...
from core.incident_machine.machines.intersection import (
    ActorMachine,
    IntersectionMachine,
)
...
class IntersectionMachineTest(unittest.TestCase):
    ...
    def test_state_and_events(self):
        ...
        _event = Event(
            ...
            event_type=EventType.PIT_EXITING_INTERSECTION,
            camera_uuid=None,
        )
